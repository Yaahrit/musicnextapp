...
function MusicSchoolContactUs() {
  // Use appropriate state variables for each input
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 pt-36 relative">
      ...
      <div className="max-w-2xl mx-auto p-4 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          {/* Use setName for the name input */}
          <input
            type="text"
            value={name}
            ...
            required
          />
          {/* Use setEmail for the email input */}
          <input
            type="email"
            value={email}
          ...
          <textarea
            ...
            required
          ></textarea>
          {/* Style the button for a clean and modern look */}
          <button
            type="submit"
